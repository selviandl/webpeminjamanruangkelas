...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
            <div class="home-logo">
                <a href="homewarek3.php"><i class="fas fa-home"></i></a>
            </div>
            <li class="nav-item">
                <a class="nav-link" href="konfirmasipeminjamanwarek3.php">Konfirmasi Peminjam</a>
            </li>
        </ul>
        <ul class="navbar-nav ml-auto">
            <form class="search-container" action="searchwarek3.php" method="GET">
                <button type="submit"><i class="fas fa-search"></i></button>
            </form>
            <li class="nav-item">
                <form class="user-container" action="profilwarek3.php" method="GET">
...
<div class="hero">
    <div>
        ...
        <h1>Selamat Datang Di SIPENGAN UNIPI</h1>
        <h2><p>Berikut tabel laporan peminjaman bulan ini</p></h2>
        <h2><p>Silahkan ke menu konfirmasi Peminjaman untuk menyetujui ruangan yang akan dipinjam</p></h2>
    </div>
</div>
<div class="content">
