...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        echo "<script>
                ...
                window.location.href = 'peminjamanadmin.php';
              </script>";
    } else {
        // Prepare and bind
...
<body>
    <div class="form-container">
        <form action="peminjamanadmin.php" method="post" onsubmit="return validateForm()">
        <center><a>Jam operasional kampus senin-jum'at 09:00 - 21:45 Minggu 09:00 - 16:00</a>
            ...
            <div class="form-group">
                <button type="button" class="cancel-button" onclick="window.location.href='homeadmin.php'">Batal</button>
            </div>
        </form>
    </div>
